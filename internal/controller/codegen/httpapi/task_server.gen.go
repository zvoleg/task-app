...
type ServerInterface interface {
	// Get a list of tasks
	// (GET /task)
	GetTaskList(w http.ResponseWriter, r *http.Request, params GetTaskListParams)
	// Creat a new task
	// (POST /task)
...
func (siw *ServerInterfaceWrapper) GetTaskList(w http.ResponseWriter, r *http.Request) {
	...
	var params GetTaskListParams

	// ------------- Optional query parameter "filterParameters" -------------

	err = runtime.BindQueryParameter("form", true, false, "filterParameters", r.URL.Query(), &params.FilterParameters)
	if err != nil {
		siw.ErrorHandlerFunc(w, r, &InvalidParamFormatError{ParamName: "filterParameters", Err: err})
		return
	}

	var handler http.Handler = http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.GetTaskList(w, r, params)
	})
...
func HandlerWithOptions(si ServerInterface, options ChiServerOptions) http.Handler {
	...
	r.Group(func(r chi.Router) {
		r.Get(options.BaseURL+"/task", wrapper.GetTaskList)
	})
	r.Group(func(r chi.Router) {
		r.Post(options.BaseURL+"/task", wrapper.CreateTask)
	})
	r.Group(func(r chi.Router) {
		r.Delete(options.BaseURL+"/task/{taskId}", wrapper.DeleteTask)
	})
	r.Group(func(r chi.Router) {
